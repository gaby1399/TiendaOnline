...
this.ServerUrl + 'SmartStore/auth/register',
user
);
}
//Login
...
return this.http
.post<any>(this.ServerUrl + 'SmartStore/auth/login', user)
.pipe(
map((user) => {
...
return this.http.post<any>(this.ServerUrl + 'SmartStore/auth/logout', {});
}
}
}
